          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a target="_blank" href="mock Quiz/webquizmock.php"><img src="images/web.png" class="con"/></a>
                  <a target="_blank" href="mock Quiz/javaquizmock.php"><img src="images/java.png" class="con"/></a>
                  <a target="_blank" href="mock Quiz/pythonquizmock.php"><img src="images/python.png" class="con"/></a>
                  <a target="_blank" href="mock Quiz/androidquizmock.php"><img src="images/android.png" class="con"/></a>
                  </div>
                </div>
              </div>
            </div>
